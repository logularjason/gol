...
MAX_GENE=100
MIN_GENE=15
NORMALISED_GENE_MIN=(MIN_GENE)*100/(MIN_GENE+3*MAX_GENE) # the smallest a gene can be after normalised
NORMALISED_GENE_MAX=(MAX_GENE)*100/(3*MIN_GENE+MAX_GENE) # the largest a gene can be after normalised
